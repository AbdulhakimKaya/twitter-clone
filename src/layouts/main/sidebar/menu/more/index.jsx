    ...
    return (
        <Popover className="relative">
            ...
            <Popover.Panel
                ...
                <Disclosure>
                    <Disclosure.Button className="px-4 h-[52px] flex items-center justify-between w-full font-bold hover:bg-[#eff3f41a] transition-colors">
                ...
                <Disclosure>
                    <Disclosure.Button
                        className="px-4 h-[52px] flex items-center justify-between w-full font-bold hover:bg-[#eff3f41a] transition-colors">
                        Ayarlar ve Destek
                        <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
                            <path
                                fill="currentColor"
